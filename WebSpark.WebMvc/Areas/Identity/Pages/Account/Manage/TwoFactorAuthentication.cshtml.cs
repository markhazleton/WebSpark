...
namespace WebSpark.WebMvc.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel(
        UserManager<UserIdentity.Data.WebSparkUser> userManager, SignInManager<UserIdentity.Data.WebSparkUser> signInManager, ILogger<TwoFactorAuthenticationModel> logger) : PageModel
    {
