...
namespace WebSpark.Admin.Areas.Recipe.Controllers;
    ...
    IRecipeImageService _recipeImageService) : RecipeBaseController
{
  ...
  {
    return View(new Controllers.RecipeImageFileModel());
  }
  ...
  public async Task<IActionResult> Create(Controllers.RecipeImageFileModel recipeImageModel)
  {
