...
namespace TriviaSpark.Core.Services
{
    ...
    /// </summary>
    public class QuestionProvider : ListProvider<Models.QuestionModel>
    {
        ...
        public Models.ScoreCardModel CalculateScore(IEnumerable<Models.MatchQuestionAnswerModel> matchQuestionAnswers)
        {
            ...
            return new Models.ScoreCardModel
            {
        ...
        private static Dictionary<string, HashSet<int>> AttemptedAnswersByQuestion(IEnumerable<Models.MatchQuestionAnswerModel> matchQuestionAnswers)
        {
        ...
        public List<Models.QuestionModel> GetCorrectQuestions(IEnumerable<Models.MatchQuestionAnswerModel> matchQuestionAnswers)
        {
        ...
        public List<Models.QuestionModel> GetIncorrectQuestions(IEnumerable<Models.MatchQuestionAnswerModel> matchQuestionAnswers)
        {
            ...
            List<Models.QuestionModel> result = Items.Where(w => unansweredQuestions.Contains(w.QuestionId)).ToList();
            return result;
        }
        public List<Models.QuestionModel> GetAttemptedQuestions(IEnumerable<Models.MatchQuestionAnswerModel> matchQuestionAnswers)
        {
            return Items.Where(q => matchQuestionAnswers.Select(s => s.QuestionId).Distinct().Contains(q.QuestionId)).ToList();
        }
        public List<Models.QuestionModel> GetUnansweredQuestions(IEnumerable<Models.MatchQuestionAnswerModel> matchQuestionAnswers)
        {
            return Items.Where(q => !matchQuestionAnswers.Select(s => s.QuestionId).Distinct().Contains(q.QuestionId)).ToList();
        }
