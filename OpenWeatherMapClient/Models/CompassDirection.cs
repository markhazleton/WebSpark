...
public class CompassDirection
{
    ...
    /// <summary>
    /// Gets the abbreviation for the direction (ex: N, SE, ESE, etc)
    /// </summary>
    ...
    public static readonly CompassDirection NORTH = new("N", "North", 348.75, 0.0, 11.25, 1, NorthDirectionFunction);
    public static readonly CompassDirection NORTH_NORTHEAST = new("NNE", "North-northeast", 11.25, 22.5, 33.75, 3, StandardDirectionFunction);
    public static readonly CompassDirection NORTHEAST = new("NE", "Northeast", 33.75, 45.0, 56.25, 2, StandardDirectionFunction);
    public static readonly CompassDirection EAST_NORTHEAST = new("ENE", "East-northeast", 56.25, 67.5, 78.75, 3, StandardDirectionFunction);
    public static readonly CompassDirection EAST = new("E", "East", 78.75, 90.0, 101.25, 1, StandardDirectionFunction);
    public static readonly CompassDirection EAST_SOUTHEAST = new("ESE", "East-southeast", 101.25, 112.5, 123.75, 3, StandardDirectionFunction);
    public static readonly CompassDirection SOUTHEAST = new("SE", "Southeast", 123.75, 135.0, 146.25, 2, StandardDirectionFunction);
    public static readonly CompassDirection SOUTH_SOUTHEAST = new("SSE", "South-southeast", 146.25, 157.5, 168.75, 3, StandardDirectionFunction);
    public static readonly CompassDirection SOUTH = new("S", "South", 168.75, 180.0, 191.25, 1, StandardDirectionFunction);
    public static readonly CompassDirection SOUTH_SOUTHWEST = new("SSW", "South-southwest", 191.25, 202.5, 213.75, 3, StandardDirectionFunction);
    public static readonly CompassDirection SOUTHWEST = new("SW", "Southwest", 213.75, 225.0, 236.25, 2, StandardDirectionFunction);
    public static readonly CompassDirection WEST_SOUTHWEST = new("WSW", "West-southwest", 236.25, 247.5, 258.75, 3, StandardDirectionFunction);
    public static readonly CompassDirection WEST = new("W", "West", 258.75, 270.0, 281.25, 1, StandardDirectionFunction);
