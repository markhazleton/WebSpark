...
{
    /// <summary>
    /// Home controller for the WebCMS area - provides dashboard and overview functionality
    /// </summary>
    public class HomeController : WebCMSBaseController
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                _logger.LogError(ex, "Error loading WebCMS dashboard");
        ...
        /// <summary>
        /// Displays help/documentation for the WebCMS system
        /// </summary>
        [HttpGet]
